                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text28 thq-body-small">
                      Schedule a consultation to thoroughly understand the
                      client&apos;s requirements, goals, and challenges.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text32 thq-body-small">
                      Create customized consulting solutions based on the
                      client&apos;s needs and industry best practices.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text27 thq-body-small">
                      Execute the agreed-upon strategies and solutions while
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text25 thq-body-small">
                      ...
                      highlighting the added value and impact on the
                      client&apos;s business.
                    </span>
                  </Fragment>
                )}
